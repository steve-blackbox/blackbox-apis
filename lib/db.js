...
function saveLicense({ licenseKey, email, plan, paddleSubscriptionId, paddleCustomerId }) {
    db.prepare(`
        INSERT INTO licenses (license_key, email, plan, active, paddle_subscription_id, paddle_customer_id)
        VALUES (?, ?, ?, 1, ?, ?)
        ON CONFLICT(license_key) DO UPDATE SET
            active = 1,
            paddle_subscription_id = excluded.paddle_subscription_id,
            paddle_customer_id = excluded.paddle_customer_id
    `).run(licenseKey, email || null, plan || null, paddleSubscriptionId || null, paddleCustomerId || null);
}
